...
data = np.genfromtxt(".\\MachineParse\\superfamily_avgCdist.csv", delimiter=' ', names=['x', 'y', 'label'])
...
ax.set_title("Feature Sets: Superfamily and Avg Distance b/w Cysteines")
